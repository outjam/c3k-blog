...
BEGIN
  ...
  ELSE
    ...
    SET
      ...
      delivery_method = COALESCE(NULLIF(p_order ->> 'delivery', ''), orders.delivery_method),
      ...
      address = COALESCE(NULLIF(p_order ->> 'address', ''), orders.address),
