...
import { clearReleaseReaction, setReleaseReaction } from "@/lib/server/release-social-store";
...
export async function PUT(
  ...
  const result = await setReleaseReaction({
    slug,
...
export async function DELETE(
  ...
  const result = await clearReleaseReaction({
    slug,
    actor: {
      telegramUserId: access.telegramUserId,
      username: access.username,
